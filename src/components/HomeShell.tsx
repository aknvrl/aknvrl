...
export function HomeShell({
    ...
    useClock(language);
    useInfiniteSlide();
    useHeadlineRotate(language);
    useIsakAnimations(language);
    ...
    return (
        <>
            ...
            <main id="wrapper">
                ...
                <UserSidebar key={`sidebar-${language}`} variant={variant} />

                <div className="main-content" key={`content-${language}`}>
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-7 col-xl-8 ms-auto">
                                <div className="wrap-container">
                                    {variant === "v1" ? (
                                        <div className="intro-about-stage">
                                            <IntroComponent />
                                            <AboutComponent />
                                        </div>
                                    ) : (
