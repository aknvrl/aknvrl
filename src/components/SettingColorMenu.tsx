        ...
        <>
            ...
            >
                <button
                    ...
                    aria-label={language === "en" ? "Open appearance settings" : "Renk ayarlarını aç"}
                >
            ...
            >
                <div className="offcanvas-content">
                    <div className="canvas-header">
                        <h5 className="letter-space--2">{language === "en" ? "Appearance Settings" : "Görünüm Ayarları"}</h5>
                        <span
                    ...
                    <div className="canvas-body">
                        <h6 className="title">{language === "en" ? "Color" : "Renk"}</h6>
