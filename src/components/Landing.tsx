          ...
          <div className="container">
            <div className="hero-top">
              <div className="landing-header">
                <Link href="/" className="logo-site">
                  ...
                  <img loading="lazy" width={48} height={32} src="/assets/images/logo/av-dark.svg" alt="AV" />
                </Link>
                <Link href="/#contact" className="tf-btn-action">
                  <span className="ic-wrap">
                    <i className="icon icon-arrow-right-top" />
                  </span>
                  <span className="text text-body-3 letter-space--05 fw-medium">İletişime Geç</span>
                  <span className="ic-wrap">
                    <i className="icon icon-arrow-right-top" />
                  </span>
                </Link>
              ...
              <div className="landing-title text-center">
                <h1 className="intro-title  text-white mb-24">
                  <span>Akın</span>
                  Yazılım ve Yapay Zekâ Portföyü <br className="d-none d-md-block" />
                  Modern <span className="type-2">Next.js</span> Deneyimi
                </h1>
                <p className="text-body-1 split-text split-lines-transform text-white-56">
                  Projelerimi farklı tema görünümleriyle keşfedin.
                </p>
              </div>
            </div>
            ...
            <div className="landing-footer flat-spacing-3">
              <div className="content text-center">
                <h1 className="intro-title  text-white mb-24">
                  <span>Akın</span>
                  Yazılım ve Yapay Zekâ Portföyü <br />
                  Birlikte <span className="type-2">üretelim</span>
                </h1>
                <Link href="/#contact" className="tf-btn-action">
                  <span className="ic-wrap">
                    <i className="icon icon-arrow-right-top" />
