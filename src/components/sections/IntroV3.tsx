    ...
    <div id="home" className="section-intro type-3 flat-spacing">
      <div className="intro-author">
        <div className="author-image">
          ...
          <img loading="lazy" width={23} height={31} src="/assets/images/avatar/aknvrl.png" alt="Akın Vural" />
        </div>
        <div className="author-info letter-space--05">
          <p className="info_name text-black">Akın Vural</p>
          <p className="info_duty text-black-50 text-body-3">{language === "en" ? englishProfile.duty : "Yazılım & Yapay Zeka Mühendisi"}</p>
        </div>
      </div>

      <h1 className="intro-title letter-space--2 ">
        {language === "en" ? "I build the future " : "Geleceği "}<span>{language === "en" ? "with software and artificial intelligence" : "yazılım ve yapay zeka ile"}</span>
        <br />
        {language === "en" ? "" : "inşa ediyorum"}
      </h1>
      ...
      <div className="counter-image-item">
        ...
        <div className="image-item">
          <div className="image">
            <ImageSwitch
              light="/assets/images/avatar/aknvrl.png"
              dark="/assets/images/avatar/aknvrl.png"
              width={543}
              height={403}
              alt="Akın Vural"
            />
          </div>
          <div className="wg-curve-text style-2">
                    <div className="icon">
                        <svg
                            width="66"
                            height="77"
